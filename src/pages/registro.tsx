      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            {pw.length > 0 && (
              <div style={{ marginTop: 8 }}>
                <div style={{ display: 'flex', gap: 4 }}>
                  {[1,2,3,4].map(n => (
                    <div key={n} style={{ flex: 1, height: 4, borderRadius: 999, background: n <= strength ? strengthColor : 'var(--color-border)', transition: 'background 0.2s' }} />
                  ))}
                </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 8, marginTop: 4 }}>
            {[['✓', 'Sin comisiones'], ['✓', 'Setup en minutos'], ['✓', 'Soporte 24/7']].map(([ic, lbl], i) => (
              <div key={i} style={{
