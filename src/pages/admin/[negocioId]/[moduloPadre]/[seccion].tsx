...
const componentMap: Record<string, Record<string, ComponentType>> = {
    ventas: {
        ...
        clientes:       dynamic(() => import('@/modules/ventas/panel/cliente/ClienteLista'), { ssr: false }),
        ...
        pos:            dynamic(() => import('@/modules/ventas/panel/pos/POSShell').then(m => m.POSShell), { ssr: false }),
