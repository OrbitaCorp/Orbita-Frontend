      ...
      {categoriasMock.map(cat => {
        ...
        return (
          <div key={cat.id}>
            ...
            >
              {isExp ? <ChevronDown size={14} color="var(--color-muted)" /> : <ChevronRight size={14} color="var(--color-muted)" />}
              <CheckBox
                checked={cState === 'all'}
                ...
                <div key={prod.id}>
                  <div
                    style={{
                      ...
                      padding: '7px 12px 7px 36px', borderBottom: '1px solid var(--color-border)',
                    }}
                  >
                    {hasVars
