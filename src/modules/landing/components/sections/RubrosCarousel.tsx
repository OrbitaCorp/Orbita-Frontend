    ...
    <section className="relative w-full bg-transparent overflow-hidden z-10">
      ...
      <div className="relative z-30 mt-4 lg:-mt-8 flex flex-col items-center gap-3 text-center px-6 pb-10 lg:pb-20">
        ...
        <div className="flex flex-wrap justify-center gap-2 mt-2">
          {RUBROS.map(r => (
            <span key={r.name} className="px-3 py-1.5 rounded-full text-xs font-semibold bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 text-slate-700 dark:text-slate-300">
              {r.name}
            </span>
          ))}
        </div>
