        ...
        <div className="flex items-center justify-center lg:justify-start">
          <div className="w-full lg:flex-1 lg:max-w-[560px] flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            >
              ...
              <span className="text-blue-600 block">en órbita.</span>
            </h1>

            <p className="text-slate-600 dark:text-slate-300 leading-relaxed mb-6 lg:mb-10 max-w-[480px]"
            ...
            >
              {PILLS.map(({ label, icon }) => (
                <span key={label} className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 text-slate-700 dark:text-slate-300 hover:border-blue-500 hover:text-blue-700 dark:hover:border-blue-500/40 dark:hover:text-white transition-colors">
                  <svg className="w-3 h-3 text-blue-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">{icon}</svg>
                  {label}
                </span>
              ))}
            </div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-slate-900 dark:text-white text-sm font-bold">+2.847 negocios</div>
                  <div className="flex items-center gap-0.5">
                    ...
                    <span className="text-xs ml-1 text-slate-500 dark:text-slate-400">4.9</span>
                  </div>
                </div>
              </div>
