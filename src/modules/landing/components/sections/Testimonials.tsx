          ...
          >
            {TESTIMONIALS.map((t, i) => (
              ...
              >
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed mb-6 italic flex-1">{t.quote}</p>
                <div className="flex items-center gap-3 mt-auto">
                  ...
                  <div>
                    ...
                    <div className="text-xs mt-0.5 text-slate-500 dark:text-slate-400">{t.role}</div>
                  </div>
                </div>
              </div>
            ))}
