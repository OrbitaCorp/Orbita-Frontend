...
## Corpus Check
- 665 files · ~308,791 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4437 nodes · 8216 edges · 293 communities (271 shown, 22 thin omitted)
...
## Communities (293 total, 22 thin omitted)
...
Cohesion: 0.05
Nodes (77): Avatar(), AvatarProps, Badge(), BadgeConfig, BadgeProps, BadgeStatus, config, Button() (+69 more)

### Community 2 - "Messaging Module"
Cohesion: 0.04
Nodes (58): IconType, Modulo, MODULOS, Props, resItem, resLabel, RUBROS, SECCION_MODULO (+50 more)

### Community 3 - "Inventory API DTOs"
Cohesion: 0.07
Nodes (44): Body, Delete, Param, Post, Put, BusinessesController, Body, Controller (+36 more)

### Community 4 - "Catalog Categories UI"
Cohesion: 0.04
Nodes (42): AppController, Controller, Get, AuditController, Controller, Get, AuditModule, Module (+34 more)
...
Cohesion: 0.05
Nodes (43): useDarkMode(), Apariencia(), ColorBlock(), FontSelect(), IconT, pageWrap, SLIDE_GRADS, ImgUploader() (+35 more)
...
Cohesion: 0.09
Nodes (25): authedFetch(), AuthError, bffFetch(), tokenStore, tryRefresh(), AuthContext, AuthContextValue, authHeaders() (+17 more)
...
Cohesion: 0.07
Nodes (27): CategoriesController, Body, Controller, Delete, Get, Param, Patch, Post (+19 more)

### Community 15 - "Returns & Credit Notes API"
Cohesion: 0.08
Nodes (31): ButtonProps, ButtonSize, ButtonVariant, sizeStyles, variantStyles, CfgField(), CfgFieldProps, pageWrap (+23 more)
...
Cohesion: 0.08
Nodes (32): Card(), CardProps, paddingMap, CardSectionProps, ClienteDetalle(), ClienteDetalleProps, iconBtn, pageWrap (+24 more)
...
Cohesion: 0.05
Nodes (42): FindMovementsQueryDto, IsIn, IsInt, IsOptional, IsUUID, Max, Min, Type (+34 more)
...
Cohesion: 0.08
Nodes (30): Toast(), ToastProps, ToastVariant, variantMap, fechaLarga(), fmtMoney(), saludoHora(), estadoStock() (+22 more)

### Community 24 - "Platform Admin DTOs"
Cohesion: 0.11
Nodes (14): RequestWithUser, MemberContext, IsArray, IsOptional, IsString, UpsertRoleDto, PermissionsController, Controller (+6 more)
...
Cohesion: 0.09
Nodes (35): ApiPermission, ApiRole, changeBusinessMode(), completeOnboarding(), confirmSubscription(), createRole(), deleteRole(), getBusiness() (+27 more)

### Community 29 - "Members Invitation DTOs"
Cohesion: 0.05
Nodes (37): 0. Decisiones cerradas, 1. Inventario de pantallas y componentes, 2. Pantalla — Apertura de caja `/tienda/pos/open`, 3.10 Modal de devolución (mostrador), 3.11 Modal egreso / ingreso de efectivo, 3.12 Permisos relevantes (POS), 3.1 Header del turno (persistente), 3.2 Búsqueda y catálogo (columna izquierda) (+29 more)

### Community 30 - "Storefront Public UI"
Cohesion: 0.11
Nodes (15): BranchesController, Controller, Get, BranchesService, Injectable, CreateBranchDto, IsBoolean, IsOptional (+7 more)

### Community 31 - "POS Modals & Drawers"
Cohesion: 0.09
Nodes (20): Get, CurrentUser, CustomerContext, assertCustomerContext(), AddressesController, Body, Controller, Delete (+12 more)
...
Cohesion: 0.08
Nodes (20): CreateReviewDto, IsString, IsUUID, HideReviewDto, IsString, ProductReviewsController, Controller, Get (+12 more)

### Community 34 - "Map Picker Component"
Cohesion: 0.08
Nodes (20): Msg, OrbiChat(), Props, QuickAction, Skeleton(), SkeletonProps, Categoria, getRubrosCatalog() (+12 more)
...
Cohesion: 0.11
Nodes (19): RequirePermission(), InventoryController, Body, Controller, Get, Post, Query, ProductsController (+11 more)
...
Cohesion: 0.09
Nodes (19): CreateMpOrderDto, IsOptional, IsUUID, CreateMpPosDto, IsOptional, IsString, IsUUID, CreateMpStoreDto (+11 more)
...
Cohesion: 0.11
Nodes (20): AuthModule, Global, Module, CustomerAuthResponse, LoginResponse, MemberAuthResponse, ForgotPasswordDto, IsEmail (+12 more)

### Community 44 - "Discount Application Selector"
Cohesion: 0.10
Nodes (17): ConversationsModule, Module, ConversationsService, Injectable, CustomerMessageDto, IsString, SendMessageDto, IsOptional (+9 more)

### Community 45 - "TypeScript Reference Types"
Cohesion: 0.10
Nodes (12): ConfirmSubscriptionDto, IsString, SubscriptionsModule, Module, PlanConfig, SubscriptionsService, Injectable, SubscriptionsWebhookController (+4 more)
...
Cohesion: 0.07
Nodes (27): dependencies, argon2, class-transformer, class-validator, jsonwebtoken, mercadopago, @nestjs/config, @nestjs/core (+19 more)

### Community 49 - "POS Cobro Payment UI"
Cohesion: 0.07
Nodes (29): devDependencies, jest, @nestjs/cli, @nestjs/testing, prisma, supertest, ts-jest, ts-node (+21 more)
...
Cohesion: 0.12
Nodes (17): AnnouncementBar(), badgeColor(), ProductCard(), Props, CATEGORIAS, PRODUCTOS, descuento(), thumbGradientAlt() (+9 more)

### Community 53 - "Config Appearance Settings"
Cohesion: 0.12
Nodes (16): CheckoutStepper(), Props, STEPS, ProdImage(), ProdImageProps, Props, Thumb(), CARRITO_INICIAL (+8 more)
...
Cohesion: 0.11
Nodes (16): FullModeOnly(), ConversationsController, Body, Controller, Get, Param, Patch, Post (+8 more)
...
Cohesion: 0.13
Nodes (11): IsString, UpsertTagDto, TagsController, Body, Controller, Delete, Get, Param (+3 more)
...
Cohesion: 0.08
Nodes (25): 1. Qué es este módulo, 2. Stack y dependencias, 3. Estructura de archivos del módulo, 4. Componentes compartidos (`ventas/_shared/`), 5. Convenciones de código, 6. State management, 7. Types del módulo (`types.ts`), 8. Reglas estrictas (+17 more)

### Community 62 - "Module Cluster 62"
Cohesion: 0.11
Nodes (17): panelUpdateBusinessConfig(), updateBusiness(), AparienciaProps, Toggle(), ConfigTabs(), ConfigTabsProps, TABS, VistaConfig (+9 more)
...
Cohesion: 0.08
Nodes (25): Caja, Cliente, `ClienteAsociado`, Cobro, `Descuento`, Descuentos, `EstadoCaja` (union), `FiltrosHistorial` (+17 more)
...
Cohesion: 0.28
Nodes (6): HeaderLinkDto, IsBoolean, IsString, HeroSlideDto, IsString, ValidateIf
...
Cohesion: 0.12
Nodes (15): CustomerEmailDto, IsArray, IsString, IsUUID, FindCustomersQueryDto, IsInt, IsOptional, IsString (+7 more)
...
Cohesion: 0.25
Nodes (8): Public(), Post, StorefrontController, Body, Controller, Get, Param, Post
...
Cohesion: 0.16
Nodes (12): AuthController, Body, Controller, Post, AcceptInvitationDto, IsString, MinLength, RefreshDto (+4 more)
...
Cohesion: 0.20
Nodes (7): MercadopagoController, Body, Controller, Get, Param, Patch, Post
...
Cohesion: 0.13
Nodes (14): [2026-07-12] GUIA_PRUEBA_MANUAL_FASES_1_2.md no existe en apps/api, [2026-07-13] `apps/api/scripts/reset-unlinked-customer.ts` no existe, [2026-07-13] Bug propio detectado y corregido en el momento: protección de borrado de Supplier basada en un supuesto incorrecto sobre el FK, [2026-07-13] Filtro `lowStock` y paginación de `GET /inventory/stock` se resuelven en memoria, [2026-07-13] `POST /inventory/adjustment` bloquea si el resultado da stock negativo, [2026-07-14] Análisis pre-implementación: 7 fallas detectadas, 4 resueltas, [2026-07-14] Módulo completo sin implementar — `CustomersService` es un stub, [2026-07-17] Aislamiento multi-tenant en AuthGuard y login/register (+6 more)
...
Cohesion: 0.19
Nodes (11): ClienteCard(), iconBtn, ListaView(), pageWrap, relTime(), DEST, EmailMasivoModal(), EmailMasivoModalProps (+3 more)

### Community 113 - "Module Cluster 113"
Cohesion: 0.14
Nodes (14): Arquitectura técnica — POS, Componentes de `_shared/` que usa el POS, Datos del servidor (Hooks), Estado (Stores Zustand), Estructura de archivos, Flujo de datos: cobro completo, [hooks/useCaja.ts](../hooks/useCaja.ts), [hooks/useClientes.ts](../hooks/useClientes.ts) (+6 more)
...
Cohesion: 0.17
Nodes (7): arrowStyle(), CATS_CARRUSEL, HERO_SLIDES, HeroCarousel(), NUEVOS_INGRESOS, OFERTA_FLASH, STATS
...
Cohesion: 0.18
Nodes (10): Arquitectura / decisiones técnicas, Auth: NO usa Supabase Auth, Ejemplo de entrada, Formato, Instrucciones permanentes para trabajar en apps/api/, Mantener PENDIENTES.md actualizado, Qué NO va en PENDIENTES.md, Qué va en PENDIENTES.md (+2 more)
...
Cohesion: 0.24
Nodes (6): BusinessesModule, Module, ChangeModeDto, IsIn, PauseBusinessDto, IsBoolean
...
Cohesion: 0.24
Nodes (6): PageLoader(), Props, Props, StorefrontLoader(), TIENDA, queryClient
...
Cohesion: 0.29
Nodes (7): Caja/, CatalogoPOS/, Cobro/, Componentes principales, Historial/, Modales/, TicketPOS/
...
Cohesion: 0.40
Nodes (5): 10. Prompts sugeridos para Claude Code, Mensaje 1 (análisis), Mensaje 2 (infraestructura), Mensaje 3 (primera pantalla), Mensajes 4-7 (POSCobro por capas)
...
Cohesion: 0.40
Nodes (5): `CategoriaPOS`, Catálogo / Productos, `FiltrosCatalogoPOS`, `ProductoPOS`, `VariantePOS`
...
Cohesion: 0.50
Nodes (4): [2026-07-13] Bug de infraestructura: `@supabase/supabase-js` no funciona en Node 20 sin polyfill de WebSocket, [2026-07-13] `pnpm add` en un subproyecto pnpm puede podar dependencias de otro `pnpm install` previo, [2026-07-18] Error intermitente: "new row violates row-level security policy" al subir a Storage — sin causa raíz confirmada, autoresuelto, Infraestructura / Entorno de desarrollo

### Community 203 - "Module Cluster 203"
Cohesion: 0.50
Nodes (3): LogoutDto, IsOptional, IsString
...
## Knowledge Gaps
- **1382 isolated node(s):** `$schema`, `collection`, `sourceRoot`, `deleteOutDir`, `mail/templates/**/*.hbs` (+1377 more)
...
- **Why does `useDarkMode()` connect `Discount Badge & Metrics` to `Module Cluster 92`, `Module Cluster 109`?**
  _High betweenness centrality (0.290) - this node is a cross-community bridge._
- **Why does `Roles()` connect `Inventory API DTOs` to `Module Cluster 128`, `Catalog Categories UI`, `MercadoPago DTOs`, `Orders API DTOs`, `Platform Admin DTOs`, `Module Cluster 152`, `NestJS Module Registry`, `Storefront Public UI`, `Auth Context Decorators`, `Storefront Product Cards`, `TypeScript Reference Types`, `Module Cluster 179`, `Message Templates DTOs`, `Storefront Me DTOs`, `Store Preview Component`, `Module Cluster 67`, `Module Cluster 75`, `Module Cluster 79`, `Module Cluster 97`, `Module Cluster 109`?**
...
- **Should `Discounts UI Components` be split into smaller, more focused modules?**
  _Cohesion score 0.04860022396416573 - nodes in this community are weakly interconnected._
